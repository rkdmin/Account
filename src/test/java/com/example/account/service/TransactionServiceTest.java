...
class TransactionServiceTest {
    ...
    void successCancelBalance() {
        ...
        assertEquals(10000 + CANCEL_AMOUNT, captor.getValue().getBalanceSnapshot());
        assertEquals(S, transactionDto.getTransactionResultType());
    ...
    void cancelBalance_TransactionNotFound() {
        // given
        given(transactionRepository.findByTransactionId(anyString()))
                .willReturn(Optional.empty());// 거래 없음
    ...
    void cancelBalance_TransactionAccountUnMatch() {
        ...
        given(accountRepository.findByAccountNumber(anyString()))
                .willReturn(Optional.of(account2));// 계좌 다름
    ...
    @Test
    @DisplayName("거래금액와 최소금액이 다름 - 잔액 사용 취소 실패")
    void cancelBalance_CancelMustFully() {
        ...
        Transaction transaction = Transaction.builder()
                ...
                .transactionId("transactionId")
                .transactedAt(LocalDateTime.now())
                .amount(CANCEL_AMOUNT + 1000L)// 금액이 다름
                .balanceSnapshot(9000L)
                .build();
    ...
    void cancelBalance_TooOldOrderToCancel() {
        ...
        Transaction transaction = Transaction.builder()
                ...
                .transactionResultType(S)
                .transactionId("transactionId")
                .transactedAt(LocalDateTime.now().minusYears(1))// 2년된계좌
